function classif=labelcolor(label,data_name,method)
...
%         map=[0 0 255;255 100 0;0 255 134;150 70 150; 100 150 255;60 90 114;255 255 125;255 0 255;100 0 255;1 170 255;0 255 0;175 175 82;100 190 56;140 67 46;115 255 172;255 255 0];
        ...
        labelname={'Alfalfa','Corn-notill','Corn-mintill','Cron','Grass-pasture','Grass-trees','Grass-pasture-mowed','Hay-windrowed','Oats',...
            'Soybean-nottill','Soybean-mintill','Soybean-clean','Wheat','Woods','Buildings-Grass-Trees-Drives','Stone-Steel-Towers'}
            for i=1:w
            for j=1:h
                switch(label(i,j))
                    case(1)
...
%             map=[0, 205, 0;127, 255, 0;46, 139, 87;0, 139, 0;160, 82, 45;0, 255, 255;255, 255, 255; 216, 191, 216;255, 0, 0;139, 0, 0;0, 0, 0;255, 255, 0;238, 154, 0;85, 26, 139;255, 127, 80];
            ...
            labelname = {'Healthy grass','Stressed grass','Synthetic grass','Trees','Soil','Water','Residential','Commercial','Road','Highway','Railway','Parking Lot 1','Parking Lot 2','Tennis Court','Running Track'};
...
file_name=strcat('D:\CXH\SSCAG\polt\picture\','_',data_name,'_',method);
t=~exist('file_name','var');
if t
...
classif(:,:,2)=im(:,:,2);
classif(:,:,3)=im(:,:,3);
 plotlebalbar(map,label,labelname,data_name,method);
